...
$query = "SELECT df.id, df.name, dfc.name as \"category\" FROM datasets_fileset df INNER JOIN datasets_fileset_category dfc ON (df.category_id = dfc.id AND dfc.id IN(1,2)) ORDER BY (CASE df.id ";
