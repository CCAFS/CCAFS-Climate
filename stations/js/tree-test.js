						...
						if (form.isValid()) {
							...
							copyrightN = 1;
								...
								var tpl = [
									...
									'<a href="http://www.cru.uea.ac.uk/" target="_blank">CRU V4</a>: Datasets interpolated monthly for global land for multiple variables with 0.5&deg; x 0.5&deg; resolution (~50 km) from 1901-2015','<br>'
